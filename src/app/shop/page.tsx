...
export default function ShopPage() {
  ...
  return (
    <Container className="min-h-screen pt-28 w-6xl flex flex-col items-start justify-start bg-transparent">
      <div className="w-full flex flex-col justify-center items-start gap-4 border-b border-neutral-200 pb-4">
        <Heading className="text-4xl pb-0">
          Our Collection for Your Style Needs
        </Heading>

        <div className="w-full flex items-center justify-between">
          <div className="flex items-center justify-center gap-3">
            <p className="text-neutral-600 text-[16px] font-bold">View:</p>
...
export const CardLayoutOne = ({
  ...
  return (
    <Link
      href={"#"}
      className="lg:w-65 lg:h-105 mt-7 flex flex-col border border-neutral-200 rounded-md overflow-hidden bg-white hover:shadow-lg transition-shadow duration-300"
    >
...
export const CardLayoutFour = ({
  ...
  return (
    <Link
      href={"#"}
      className="w-full h-40 mt-7 flex items-center justify-between gap-10 border border-neutral-200 rounded-md overflow-hidden bg-white hover:shadow-lg transition-shadow duration-300"
    >
      <div className="w-60 h-full relative">
        <Image src={src} alt="shop" fill className="object-cover" />
      </div>

      <div className=" h-full  flex flex-col items-start justify-center px-6 py-4 bg-white">
        <div className="flex flex-col items-start justify-center gap-1">
          <span className="text-[15px]  tracking-[0.2em] text-neutral-700 font-bold ">
            {category}
          </span>
          ...
          <p className="text-md w-200 text-neutral-500 line-clamp-2 leading-relaxed">
            {description}
          </p>
